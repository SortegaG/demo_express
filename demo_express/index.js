...
// Rutas
const booksRoutes = require("./routes/books.routes") // Importa rutas
...
// Rutas
//API
app.use('/api/books',checkApiKey,booksRoutes, );  // /api/books es el prefijo de todas las rutas que van a tener las booksRoutes. Esto habilita las rutas
app.use('/api/products',productsRoutes);
app.use('/api/entries',entriesRoutes);

// GET http://localhost:3000/perros/toby?API_KEY=123abc
